...
import com.umang345.bankacc.cmd.api.dto.OpenAccountResponse;
...
public class OpenAccountController
{
    ...
    public ResponseEntity<OpenAccountResponse> openAccount(@Valid @RequestBody OpenAccountCommand command)
    {
        ...
        try{
            ...
            return new ResponseEntity<>(new OpenAccountResponse(id,"Successfully created a new Bank Account"),HttpStatus.CREATED);
        }
        catch (Exception e)
        {
